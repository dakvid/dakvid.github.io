...
(**EDIT:** the R package has been renamed [distill](https://rstudio.github.io/distill/).)
...
off.
(**EDIT:** OK, so that was slightly optimistic, but at least the gap was less
than a year. I've been reading some good books instead!)
...
The key [issue](https://github.com/rstudio/distill/issues/20) for me is code highlighting.
...
Thanks [JJ](https://github.com/rstudio/distill/commits?author=jjallaire)!
