...
description: Some reflections on trying to find out information about local government elections.
...
STV elections, as I've [recently discovered](../2016-11-simple-to-vote/), are not so straightforward.
...
[low voter turnout](../2016-10-whither-local-democracy/) in local body elections.
...
With the RTF and a few of the PDFs I could copy the data directly into a
...
The icons give more detail when the mouse hovers, but if you're on a mobile device you
should be able to tap to display.
...
One notable variation between the agencies is whether an initial acknowledgement is sent.
...
I was surprised that there were a few agencies that sent me or directed me to something other
...
There are actually very good government guidelines from NZGOAL about
...
and visualisation. (Especially if my kids will stay out of hospital.)
...
but it seems that that information is not stored for long. But there's enough to work with for now.



## Data {.appendix}

The [CSV file](data/stv_oia_events.csv) of event data.
