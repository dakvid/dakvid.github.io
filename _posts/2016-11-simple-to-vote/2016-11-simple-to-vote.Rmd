...
description: Animations to visualise New Zealand local body elections using STV (Single Transferable Vote).
author: "David Friggens"
date: 2016-11-08
preview: images/stv2016_wrc_porirua-tawa.gif
categories:
  - all
  - R
  - elections
...
Recently we had local body elections in New Zealand. (You may [have heard](../2016-10-whither-local-democracy/).)
...
<aside>
For example, in [Waipa District Council](http://www.waipadc.govt.nz/our-council/Elections/Pages/Results.aspx),
...
In areas using STV, the election is no different to if they had not been on the ballot paper.
...
![animated bar graph of 2016 Wellington Regional Council Kapiti Coast Constituency STV election results](images/stv2016_wrc_kapiti.gif)
...
<img src="images/placeholder_stv2016_wcc_mayor.png" alt="Placeholder for 5.1MB animated graph. Click to load with JavaScript" />
</div>
<script>
$(function(){
...
<img src="images/placeholder_stv2010_wcc_mayor.png" alt="Placeholder for 3.5MB animated graph. Click to load with JavaScript" />
</div>
<script>
$(function(){
...
![animated bar graph of 2016 Wellington Regional Council Porirua-Tawa constituancy STV election](images/stv2016_wrc_porirua-tawa.gif)
...
<img src="images/placeholder_stv2016_kcdc_waikanae_cb.png" alt="Placeholder for 7.8MB animated graph. Click to load with JavaScript" />
</div>
<script>
$(function(){
...
library(readr)
stv16 <- read_csv("data/summary_stv_counts.csv")
library(plotly)
plot_ly() %>% 
...
I produced the animations separately, so don't have the code available.
The API for [`gganimate`](https://github.com/thomasp85/gganimate) has
changed considerably since then anyway.
